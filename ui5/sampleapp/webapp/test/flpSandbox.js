		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapbtpsampleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpsampleapp-display": {
								"semanticObject": "sapbtpsampleapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.sampleapp",
									"url": sap.ui.require.toUrl("sap/btp/sampleapp")
								}
							}
						}
					}
