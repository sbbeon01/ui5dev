		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "travel app",
									"targetURL": "#abapbtpui5abapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"abapbtpui5abapui5-display": {
								"semanticObject": "abapbtpui5abapui5",
								"action": "display",
								"description": "A Fiori application travel company",
								"title": "travel app",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=abap.btp.ui5.abapui5",
									"url": sap.ui.require.toUrl("abap/btp/ui5/abapui5")
								}
							}
						}
					}
